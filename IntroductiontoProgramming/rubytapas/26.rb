...
module PulseAudio
	...
	callback :pa_context_notify_cd_t, [:pa_context, :userdata], :void
	callback :pa_source_info_cd_t, [:pointer, :pointer, :int, :pointer], :void                        		
	...
	attach_function :pa_context_connect, [:pa_context, :string, :pa_context_flags, :pointer], :void
	attach_function :pa_context_disconnect, [:pa_context], :void
	attach_function :pa_context_set_state_callback, [:pa_context, :pa_context_notify_cd_t, :pointer], :void
...
pa_context_set_state_callback(context, start_query_when_ready, nil)
